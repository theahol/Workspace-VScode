...
pos_from_simulation = "serverDouble_sin_test4.json"
Pos_from_robot = "serverDouble_robot_test4.json"
...
TrajPoints_fromSim = get_joint_values_from_file(filepath="serverDouble_sin_test4.json", variable_name="joint_values")
...
for row in TrajPoints_fromSim:
    ...
    data = json.load(open(Pos_from_robot))
    data_vec = data["joint_values"]
    data_vec.append(vec)
    data["joint_values"] = data_vec 
        
    with open(Pos_from_robot, "w") as f:
